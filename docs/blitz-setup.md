...
4. **Get my OpenAI API key.** Ask me to paste it. **Do NOT echo the key back in chat or write it to any file.** Store in macOS Keychain:
   ```
...
9. **Default hotkeys (hold to talk):**
...
10. **Test.** Tell me to open Notes.app, click into the text area, hold Right-Option, say "hello world", release. Text should appear. If nothing happens, debug: `log show --predicate 'process == "Blitz"' --last 2m`.
